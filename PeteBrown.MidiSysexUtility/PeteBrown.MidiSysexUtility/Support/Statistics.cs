...
namespace PeteBrown.MidiSysexUtility
{
    class Statistics : SettingsBase
    {
        ...
        private const string UserHasRatedApp_key = "UserHasRatedApp";
        ...
        public static bool UserHasRatedApp
        {
            get { return GetValueOrDefault<bool>(UserHasRatedApp_key, false); }
            set { WriteValue<bool>(UserHasRatedApp_key, value); }
        }
